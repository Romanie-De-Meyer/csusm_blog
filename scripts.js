...
function populateMisc() {
    ...
    fetch('php/miscAJAX.php')
        ...
        .catch(error => console.error('Error fetching miscellaneous articles:', error));
}
function populateAcademic() {
    ...
    fetch('php/academicAJAX.php')
        ...
        .catch(error => console.error('Error fetching academic articles:', error));
}
...
function populateHealthwell() {
    ...
    fetch('php/healthwellAJAX.php')
        ...
        .catch(error => console.error('Error fetching healthwell articles:', error));
}
